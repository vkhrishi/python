...
def run_backtest_fib(days=30):
    ...
    _print_bt_report_fib(trades, signals, days, approx=True)
...
def run_backtest_fib_real(days=30):
    ...
    _print_bt_report_fib(trades, signals, days, approx=False)


def _print_bt_report_fib(trades, signals, days, approx=True):
    print("\n" + "=" * 60)
