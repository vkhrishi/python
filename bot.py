...
ADX_LEN              = 14
ATR_LEN              = 14
MAX_SL_ATR_MULT      = 2.0     # Reject setups whose fib-SL is wider than this x ATR
                               # (tightened 3.0 -> 2.0: a >2x ATR stop is too far for
                               #  the target to be hit before price mean-reverts)
RSI_LEN              = 14
EMA_FAST             = 9
EMA_SLOW             = 21
...
def check_fib_retracement(candles, fib_data, now=None):
    ...
    # ATR-based SL sanity check (SL shouldn't be wider than MAX_SL_ATR_MULT x ATR)
    if atr is not None and atr > 0:
        ...
        if fib_sl_distance > atr * MAX_SL_ATR_MULT:
