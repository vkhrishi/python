...
RR_RATIO          = 3.0       # Target = SL x 3.0 (far TP; trailing SL usually exits first)
...
TRAILING_SL_TRIGGER  = 0.33    # Start trailing at ~1:1 profit (0.33 x 1:3 target) - protect along the way
TRAILING_SL_STEP     = 0.50    # Lock 50% of open profit (was 0.50) - protect winners
